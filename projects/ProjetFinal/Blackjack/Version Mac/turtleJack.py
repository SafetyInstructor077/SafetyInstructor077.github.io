...
dessineur.write("Contrôles: ", font=("Helvetica Neue", 20, 'bold'), align="center")

dessineur.setposition(-0.5 * screen.window_width() + 60, 0.5*screen.window_height()-50)
dessineur.write("ESPACE - Hit", font=("Helvetica Neue", 15), align="center")

dessineur.setposition(-0.5 * screen.window_width() + 60, 0.5*screen.window_height()-70)
dessineur.write("S - Rester", font=("Helvetica Neue", 15), align="center")
#################################################################
...
dessineur.write("Balance:", font=("Helvetica Neue", 40), align="center")
...
annonce_balance.write(balance, font=("Helvetica Neue", 40), align="center") # Écrit la balance de l'utilisateur
...
dessineur.write("Record Actuel: ", font=("Helvetica Neue", 20, "bold"), align="center") # On écrit "Record Actuel" dans le panneau
...
with open("record.txt", "r") as record: # On ouvre le fichier record.txt, qui stocke le record actuel
    dessineur.write(record.read(), font=("Helvetica Neue", 25), align="center") # On affiche le record actuel
